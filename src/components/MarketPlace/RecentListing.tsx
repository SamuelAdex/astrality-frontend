...
const RecentListing = () => {
  ...
  return (
    <div className='md:px-12 md:w-[95%] w-full m-auto m-[0px] rounded-[12px] px-5 py-[2.5rem] mb-20 recent-listing'>
        <div className="flex md:flex-row flex-col justify-between md:items-center">
            ...
            <div className="">
                <Button
                    text={"See All"}
                    btnStyle={"border-white md:mt-0 mt-4 text-white w-full flex-row-reverse font-bold md:text-[16px] p-4 text-[14px]"}
                    type={"outline"}
                    iconName={<MdOutlineKeyboardDoubleArrowRight fontSize={"1.2rem"} color={"#fff"} />}
                    onBtnClick={()=> router.push('/marketplace/listing') }
                />
            </div>
        </div>
