...
const Reward = () => {
  return (
    <div className='md:mt-[10rem] mt-[5rem] rewards relative overflow-hidden'>
        <div className="md:h-[900px] h-[600px]">
            <div className='w-[100%] h-[100%] absolute md:top-0 top-[-10rem] overflow-hidden -z-5 md:right-[-25%]'>
            ...
            <div className='flex flex-col absolute z-10 md:justify-center lg:p-8 p-8 h-full gap-12'>
                <div className='lg:w-[45%] w-full'>
                    ...
                    <div className='flex md:flex-row flex-col items-center md:gap-10 gap-5 mt-12'>
                        <Button
                            type={""}
                            text={'Join Now'}
